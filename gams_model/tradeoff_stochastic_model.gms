...
scalars
        ...
        lambda "priority between minimizing average dissatisfaction and max dissatisfaction" /1/;
...
dis(r) =e= (1-quitprob(t))*sum(a, b(r,a) * sum(headr, rank(r, headr)*(apt_data(a, headr)-res_data(r, headr))))
        + (1-quitprob(t))*sum(a, b(r,a) * rank(r,'com_t')*(sum(m $ r_method(r,m), apt_com_t_nm(a,m)) -res_data(r,'com_t')));
